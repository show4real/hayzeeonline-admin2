...
const AddNotice = ({ addNotice, toggle }) => {
  ...
  const handleSubmit = (e) => {
    ...
    data.set("notice", fields.name);

    return axios
      .post(
        `${settings.API_URL}store/notice`,
        data,
        {
          headers: {
      ...
      <div className="col-12 grid-margin stretch-card">
        <div className="card">
          <div className="card-body">
            ...
            <h4 className="card-title">Create Notice</h4>
